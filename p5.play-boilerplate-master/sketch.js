...
function setup() {
  ...
  base = new Ground(390,360 ,250,10);
  base2 = new Ground(550,240 ,180,10);
...
World.add(world, polygon.body);
  ...
  World.add(world, block2.body);
  World.add(world, block3.body);
  World.add(world, block4.body);
  World.add(world, block5.body);
  World.add(world, block6.body);
  World.add(world, block7.body);
  World.add(world, block8.body);
  World.add(world, block9.body);
  World.add(world, block10.body);
  World.add(world, block11.body);
  World.add(world, block12.body);
  World.add(world, block13.body);
  World.add(world, block14.body);
  World.add(world, block15.body);
  World.add(world, block16.body);
  World.add(world, block17.body);
  World.add(world, block20.body);
  World.add(world, block21.body);
  World.add(world, block22.body);
  World.add(world, block23.body);
  World.add(world, block24.body);
  World.add(world, block25.body);
  World.add(world, block26.body);
  World.add(world, block27.body);
  World.add(world, block28.body);
}
